...
{
public:
    enum { AlphaBeta, AttackClosest, Kiter, Random, AttackWeakest, AttackDPS, KiterDPS, KiterDPSEvo, NOKDPS, Kiter_NOKDPS, Cluster, PortfolioGreedySearch, UCT, None, Size };
    static void init()
    {
		...
		setData(KiterDPSEvo, "KiterDPSEvo");
